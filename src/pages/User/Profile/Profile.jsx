    ...
    <S.Profile>
      ...
      <S.ProfileInfo>
              ...
              <S.DateSelect>
                <Controller
                  ...
                  render={({ field }) => (
                    <S.SelectDate
                      title="Ngày"
                      options={range(1, 32).map(item => ({ name: item, value: item }))}
                ...
                <Controller
                  ...
                  render={({ field }) => (
                    <S.SelectDate
                      title="Tháng"
                      options={range(0, 12).map(item => ({ name: item + 1, value: item }))}
                      onChange={field.onChange}
                ...
                <Controller
                  ...
                  render={({ field }) => (
                    <S.SelectDate
                      title="Năm"
                      options={range(1900, 2022).map(item => ({ name: item, value: item }))}
                      onChange={field.onChange}
        ...
        <S.ProfileRight>
          <S.AvatarUploader>
            <S.Avatar>
              <img src="https://cf.shopee.vn/file/1b4746741e4d0cb7a2f7e81fc510718c" alt="" />
            </S.Avatar>
